...
import { Code, Globe, Smartphone, Database, ArrowRight } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Custom web solutions built with modern frameworks and technologies for performance and scalability.",
    },
    {
      icon: Smartphone,
    ...
    },
    {
      icon: Database,
      title: "Backend & APIs",
      description: "Robust server-side architecture, database design, and RESTful/GraphQL APIs.",
    },
    {
      icon: Code,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Building robust, scalable, and high-performance digital solutions using cutting-edge
